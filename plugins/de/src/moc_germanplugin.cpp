/****************************************************************************
** Meta object code from reading C++ file 'germanplugin.h'
**
...
#include "germanplugin.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#include <QtCore/qplugin.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'germanplugin.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_GermanPlugin_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_GermanPlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GermanPlugin_t qt_meta_stringdata_GermanPlugin = {
    {
QT_MOC_LITERAL(0, 0, 12) // "GermanPlugin"
...
static const uint qt_meta_data_GermanPlugin[] = {
...
void GermanPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject GermanPlugin::staticMetaObject = {
    { &WesternLanguagesPlugin::staticMetaObject, qt_meta_stringdata_GermanPlugin.data,
      qt_meta_data_GermanPlugin,  qt_static_metacall, nullptr, nullptr}
};


const QMetaObject *GermanPlugin::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *GermanPlugin::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_GermanPlugin.stringdata0))
...
int GermanPlugin::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
QT_MOC_EXPORT_PLUGIN(GermanPlugin, GermanPlugin)
