/****************************************************************************
** Meta object code from reading C++ file 'englishplugin.h'
**
...
#include "englishplugin.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#include <QtCore/qplugin.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'englishplugin.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_EnglishPlugin_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_EnglishPlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_EnglishPlugin_t qt_meta_stringdata_EnglishPlugin = {
    {
QT_MOC_LITERAL(0, 0, 13) // "EnglishPlugin"
...
static const uint qt_meta_data_EnglishPlugin[] = {
...
void EnglishPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject EnglishPlugin::staticMetaObject = {
    { &WesternLanguagesPlugin::staticMetaObject, qt_meta_stringdata_EnglishPlugin.data,
      qt_meta_data_EnglishPlugin,  qt_static_metacall, nullptr, nullptr}
};


const QMetaObject *EnglishPlugin::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *EnglishPlugin::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_EnglishPlugin.stringdata0))
...
int EnglishPlugin::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
QT_MOC_EXPORT_PLUGIN(EnglishPlugin, EnglishPlugin)
