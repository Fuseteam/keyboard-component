/****************************************************************************
** Meta object code from reading C++ file 'catalanplugin.h'
**
...
#include "catalanplugin.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#include <QtCore/qplugin.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'catalanplugin.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_CatalanPlugin_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CatalanPlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CatalanPlugin_t qt_meta_stringdata_CatalanPlugin = {
    {
QT_MOC_LITERAL(0, 0, 13) // "CatalanPlugin"
...
static const uint qt_meta_data_CatalanPlugin[] = {
...
void CatalanPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject CatalanPlugin::staticMetaObject = {
    { &WesternLanguagesPlugin::staticMetaObject, qt_meta_stringdata_CatalanPlugin.data,
      qt_meta_data_CatalanPlugin,  qt_static_metacall, nullptr, nullptr}
};


const QMetaObject *CatalanPlugin::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *CatalanPlugin::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CatalanPlugin.stringdata0))
...
int CatalanPlugin::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
QT_MOC_EXPORT_PLUGIN(CatalanPlugin, CatalanPlugin)
